...
- Calories are represented per day and per exercise session using OHealth-origin records only, preferring active-calorie records with an OHealth total-calorie fallback.
